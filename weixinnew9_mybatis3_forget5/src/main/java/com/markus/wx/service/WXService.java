...
public class WXService {
	...
	private BaseMessage dealTextMessage(Map<String, String> requestMap) {
		...
		if(msgContent.equals("登录")) {
			...
			String url ="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx98b0a5b92b436370&redirect_uri=http://yzcoder.nat300.top/wx/getuserinfo&response_type=code&scope=snsapi_userinfo#wechat_redirect";
			TextMessage tm = new TextMessage(requestMap, "欢迎您来到Markus的公众号，目前公众号还在建设中，敬请期待！<a href=\""+url+"\" >请点击</a>");
			return tm;
		}
